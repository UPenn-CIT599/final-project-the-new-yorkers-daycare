...
public class Recommender {
	 ...
	 * inspection records--the most recent inspection results of each center within the 
	 * specified zip code. (This ArrayList is generated by the Genie class.)
	 * 
	...
	private ArrayList<Model> GreenCenters = new ArrayList<Model>(); 
	// ArrayList to store the best childcare centers
	
	private ArrayList<Model> YellowCenters = new ArrayList<Model>(); 
	// ArrayList to store middle-tier childcare centers
	
	private ArrayList<Model> RedCenters = new ArrayList<Model>(); 
	...
	public void assignRatings(ArrayList<Model> centers) {
		...
		for (Model center : centers) {
			int score = 0;
			score += compareAgainstCityAverage(center.getViolationRate(), 
					center.getCityAverageViolationRate());
			score += compareAgainstCityAverage(center.getPHHViolationRate(), 
					center.getCityAveragePHHViolationRate());
			score += compareAgainstCityAverage(center.getCritViolationRate(), 
					center.getCityAverageCritViolationRate());
			if (score == 3) {
	...
	public void sortByInspectionDate(ArrayList<Model> centers) {
		/*
	...
	public ArrayList<Model> getGreenCenters() {
		return GreenCenters;
	}

	public void setGreenCenters(ArrayList<Model> greenCenters) {
		GreenCenters = greenCenters;
	}

	public ArrayList<Model> getYellowCenters() {
		return YellowCenters;
	}

	public void setYellowCenters(ArrayList<Model> yellowCenters) {
		YellowCenters = yellowCenters;
	}

	public ArrayList<Model> getRedCenters() {
		return RedCenters;
	}

	public void setRedCenters(ArrayList<Model> redCenters) {
