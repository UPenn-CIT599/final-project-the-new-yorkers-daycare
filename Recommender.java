...
public class Recommender {
	...
	/*
	 * The Recommender class's assignRatings method takes in an HashMap of childcare center 
	 * inspection records (DayCareProviderModel)--mapping each center with the 
	 * specified zip code and child care type to its most recent inspection results 
	 *  (This HashMap is generated by the Genie class.)
	 * 
